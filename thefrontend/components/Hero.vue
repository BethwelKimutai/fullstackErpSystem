        ...
        <div class="bg-white px-10 py-8 rounded-xl w-screen shadow-md max-w-sm">
          ...
          <div class="space-y-4">
            ...
            <div>
              ...
              <input id="username" v-model="username" type="text" class="bg-indigo-50 px-4 py-2 outline-none rounded-md w-full" />
            </div>
            <div>
              <label for="password" class="block mb-1 text-gray-600 font-semibold">Password</label>
              <input id="password" v-model="password" type="password" class="bg-indigo-50 px-4 py-2 outline-none rounded-md w-full" />
            </div>
            <div class="flex items-center justify-between">
          ...
          <button @click="submitLogin" class="mt-4 w-full bg-yellow-500 font-semibold py-2 rounded-md tracking-wide">Login</button>
          <div>
